...
${OBJECTDIR}/AsianOption.o: AsianOption.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AsianOption.o AsianOption.cpp

${OBJECTDIR}/BasketOption.o: BasketOption.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BasketOption.o BasketOption.cpp
...
${OBJECTDIR}/MonteCarlo.o: MonteCarlo.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MonteCarlo.o MonteCarlo.cpp
...
${OBJECTDIR}/PerformanceOption.o: PerformanceOption.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PerformanceOption.o PerformanceOption.cpp

${OBJECTDIR}/TestAsian.o: TestAsian.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TestAsian.o TestAsian.cpp

${OBJECTDIR}/TestPerformance.o: TestPerformance.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TestPerformance.o TestPerformance.cpp

${OBJECTDIR}/Tests/TestBlackScholes.o: Tests/TestBlackScholes.cpp 
	${MKDIR} -p ${OBJECTDIR}/Tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Tests/TestBlackScholes.o Tests/TestBlackScholes.cpp

${OBJECTDIR}/Tests/TestBlackScholes2.o: Tests/TestBlackScholes2.cpp 
	${MKDIR} -p ${OBJECTDIR}/Tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Tests/TestBlackScholes2.o Tests/TestBlackScholes2.cpp

${OBJECTDIR}/Tests/TestMonteCarloZero.o: Tests/TestMonteCarloZero.cpp 
	${MKDIR} -p ${OBJECTDIR}/Tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Tests/TestMonteCarloZero.o Tests/TestMonteCarloZero.cpp
...
${OBJECTDIR}/testBasket.o: testBasket.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/testBasket.o testBasket.cpp
